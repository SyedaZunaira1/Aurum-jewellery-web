    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" id="price" step="0.01" name="price" class="form-control" value="{{ old('price') }}"
                required autocomplete="transaction-amount">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" id="rating" step="0.1" min="0" max="5" name="rating" class="form-control"
                value="{{ old('rating', 0) }}" placeholder="Enter rating (e.g., 4.5)" autocomplete="off">
            <small class="text-muted">Enter a rating between 0 and 5</small>
        </div>

        <div class="mb-3">
            <label for="image" class="form-label">Image</label>
            <input type="file" id="image" name="image" class="form-control" aria-label="Product Image" accept="image/*">
